...
let
  ...
  src = pkgs.fetchzip {
    url = "https://github.com/neosam/shifty-dioxus/releases/download/v0.1.5/shifty-frontend-v0.1.5.tgz";
    sha256 = "sha256-R9ugcP2V/gL8DaPx9RpC11/AkHURM23Y6Qj7Jiz9xdM=";
  };
