...
let
  ...
  src = pkgs.fetchzip {
    url = "https://github.com/neosam/shifty-dioxus/releases/download/v1.0.5/shifty-frontend-v1.0.5.tgz";
    sha256 = "sha256-hvrAlxZyjCJrh60s/QUyUwgurVCw+RRDGKTz03w9wrc=";
  };
