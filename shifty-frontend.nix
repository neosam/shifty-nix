...
let
  ...
  src = pkgs.fetchzip {
    url = "https://github.com/neosam/shifty-dioxus/releases/download/v1.0.7/shifty-frontend-v1.0.7.tgz";
    sha256 = "sha256-Jdq4vwhyH9DCXmUIAB4OU+BT1/gdbiPgJmu97id+kRE=";
  };
