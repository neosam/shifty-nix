...
let
  ...
  src = pkgs.fetchzip {
    url = "https://github.com/neosam/shifty-dioxus/releases/download/v0.1.12/shifty-frontend-v0.1.12.tgz";
    sha256 = "sha256-VDmuzuC3m7Z+xc79c/4rNquZCcWAaybBL2ljTKr9eP0=";
  };
