...
let
  ...
  src = pkgs.fetchzip {
    url = "https://github.com/neosam/shifty-dioxus/releases/download/v0.4.1/shifty-frontend-v0.4.1.tgz";
    sha256 = "sha256-z6JMMEet+wUVmx+Wyhazb1gWtEdUD687uFFOAIQ7900=";
  };
