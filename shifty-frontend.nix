...
let
  ...
  src = pkgs.fetchzip {
    url = "https://github.com/neosam/shifty-dioxus/releases/download/v1.2.0/shifty-frontend-v1.2.0.tgz";
    sha256 = "sha256-usEUcMFPJfhFQQc7EBptYFTlr+k/ju3rQsSa3WLK6Fo=";
  };
