...
let
  ...
  src = pkgs.fetchzip {
    url = "https://github.com/neosam/shifty-dioxus/releases/download/v0.6.0/shifty-frontend-v0.6.0.tgz";
    sha256 = "sha256-STcRnxIj4z/wRxhdexc+BBw/zP0CuWb7DuVC3Y4H6OM=";
  };
