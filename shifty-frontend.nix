...
let
  ...
  src = pkgs.fetchzip {
    url = "https://github.com/neosam/shifty-dioxus/releases/download/v1.0.0/shifty-frontend-v1.0.0.tgz";
    sha256 = "sha256-nMebSO8QSXQdxSVAopNHUcA6bpLAyLJrolucKyw8uZQ=";
  };
