...
let
  ...
  src = pkgs.fetchzip {
    url = "https://github.com/neosam/shifty-dioxus/releases/download/v0.11.0/shifty-frontend-v0.11.0.tgz";
    sha256 = "sha256-RT+iv+/7D20etiqm1trTBQAeRaMC0hfk7cvkrzB09aE=";
  };
