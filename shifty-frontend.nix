...
let
  ...
  src = pkgs.fetchzip {
    url = "https://github.com/neosam/shifty-dioxus/releases/download/v0.3.0/shifty-frontend-v0.3.0.tgz";
    sha256 = "sha256-OFN+EivI4XfuNwWre5O5Ll4wGrBwZlwEJCAPkKukwzs=";
  };
