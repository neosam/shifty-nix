...
let
  ...
  src = pkgs.fetchzip {
    url = "https://github.com/neosam/shifty-dioxus/releases/download/v0.1.13-2/shifty-frontend-v0.1.13-2.tgz";
    sha256 = "sha256-vIHg/vbdCrMwIbQqypcSmHxPfOLJ58VY+e8xfgKAkoY=";
  };
