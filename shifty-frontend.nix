...
let
  ...
  src = pkgs.fetchzip {
    url = "https://github.com/neosam/shifty-dioxus/releases/download/v1.0.6/shifty-frontend-v1.0.6.tgz";
    sha256 = "sha256-5vmIuSbccvXQGKoaj19mSw+qvIdiQLoHbCQ5Dv2iuu4=";
  };
