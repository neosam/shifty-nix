...
let
  ...
  src = pkgs.fetchzip {
    url = "https://github.com/neosam/shifty-dioxus/releases/download/v1.2.2/shifty-frontend-v1.2.2.tgz";
    sha256 = "sha256-bHvUqE4wEa6HHeL47qZE1ARjepUR+z036LXTW6+pCCI=";
  };
