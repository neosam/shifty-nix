...
let
  ...
  src = pkgs.fetchzip {
    url = "https://github.com/neosam/shifty-dioxus/releases/download/v0.12.1/shifty-frontend-v0.12.1.tgz";
    sha256 = "sha256-BjzHIy85gTnx2G295UsO2dmfYM74IDm+hlecpmT9sfo=";
  };
