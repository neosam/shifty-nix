...
let
  ...
  src = pkgs.fetchzip {
    url = "https://github.com/neosam/shifty-dioxus/releases/download/v0.2.0-dev-05/shifty-frontend-v0.2.0-dev-05.tgz";
    sha256 = "sha256-+/GJxSCwXd8VKNIl9qGpt7IzzKOnBQiwFyMUQT2SJD8=";
  };
  mkDerivation = specificPkgs.stdenv.mkDerivation;
in
  mkDerivation {
    pname = "shifty-frontend";
    version = "v0.2.0-dev-05";
    src = src;
