...
let
  ...
  src = pkgs.fetchzip {
    url = "https://github.com/neosam/shifty-dioxus/releases/download/v0.1.13/shifty-frontend-v0.1.13.tgz";
    sha256 = "sha256-Xfx2wSNnVvTYeHQOMUIPevY2KQYRl+yNNFGrSu9Zf2g=";
  };
