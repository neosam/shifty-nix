...
let
  ...
  src = pkgs.fetchzip {
    url = "https://github.com/neosam/shifty-dioxus/releases/download/v0.1.1-dev01/shifty-frontend-v0.1.1-dev01.tgz";
    sha256 = "sha256-SNit2+w/heAEMoYIrDVuLMOVNAjGp7HiXFZRFdBumMk=";
  };
