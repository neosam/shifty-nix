...
let
  ...
  src = pkgs.fetchzip {
    url = "https://github.com/neosam/shifty-dioxus/releases/download/v0.1.10-dev-01/shifty-frontend-v0.1.10-dev-01.tgz";
    sha256 = "sha256-OfzI/Mr00PGNysNFDcrM4WIheU5KSP2tO76UFkvhUhs=";
  };
  mkDerivation = specificPkgs.stdenv.mkDerivation;
in
  mkDerivation {
    pname = "shifty-frontend";
    version = "v0.1.10-dev-01";
    src = src;
