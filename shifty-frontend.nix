...
let
  ...
  src = pkgs.fetchzip {
    url = "https://github.com/neosam/shifty-dioxus/releases/download/v1.0.2/shifty-frontend-v1.0.2.tgz";
    sha256 = "sha256-3Tw4xYMyvcZT3h216Ldwu0tb4FiTb3Hycf8s30BxSUo=";
  };
