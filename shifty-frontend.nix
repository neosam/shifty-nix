...
let
  ...
  src = pkgs.fetchzip {
    url = "https://github.com/neosam/shifty-dioxus/releases/download/v0.5.0/shifty-frontend-v0.5.0.tgz";
    sha256 = "sha256-4prTD2sx56KxS2AkYqvyDHh+AVmhzmca3IP2ixNwvk4=";
  };
